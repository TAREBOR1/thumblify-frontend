    ...
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                ...
                <Link href="/">
                    <Image className="size-10 aspect-square" src="/assets/logo.svg" alt="logo" width={40} height={40} priority />
                </Link>
            ...
            >
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <Link href="/">Thumblify</Link></p>
            </motion.div>
        </footer>
    );
}