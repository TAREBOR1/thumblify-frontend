...
export default function page(){
    ...
    return (
        <>
            <SoftBackDrop/>
            <div className="pt-24 md:pt-32 min-h-screen px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
                        ...
                        <div className="space-y-6">
                            <div className="p-4 sm:p-5 md:p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                                ...
                                <button 
                                    ...
                                    className="text-sm md:text-[15px] w-full py-3 md:py-3.5 rounded-xl font-medium bg-linear-to-b from-pink-500 to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed transition-colors" 
                                    disabled={loading}
                                >
